...
def test_get_search_matches():
    search_match = IML_TEST.get_search_matches(corpus=CORPUS, document_id=DOC, min_score='0.5')
...
def test_get_search_matches_text():
    ...
    search_match = IML_TEST.get_search_matches(corpus=CORPUS, document_id=DOC, min_score='0.5', text=keywords)
    assert search_match.document_id == DOC
    assert search_match.title is not None
    assert search_match.passages is not None
    passages_map = search_match.passages
...
def test_get_search_matches_limit():
    search_match = IML_TEST.get_search_matches(corpus=CORPUS, document_id=DOC, min_score='0.5', limit=5)
    assert search_match.document_id == DOC
    assert search_match.title is not None
    assert search_match.passages is not None
    passages_map = search_match.passages
...
def test_get__matches_fields_filter():
    ...
    search_match = IML_TEST.get_search_matches(corpus=CORPUS, document_id=DOC, min_score='0.5', fields=fields)
    assert search_match.document_id == DOC
    assert search_match.title is not None
    assert search_match.passages is not None
    passages_map = search_match.passages
