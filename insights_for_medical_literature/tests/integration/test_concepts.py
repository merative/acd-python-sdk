...
def test_get_from_cuis():
    ...
    cui = CUI
    cuis.append(cui)
    concept_list = IML_TEST.get_concepts(CORPUS, cuis=cuis, limit=VALID_LIMIT)
...
def test_get_from_cuis_verbose():
    ...
    cui = CUI
    cuis.append(cui)
    concept_list = IML_TEST.get_concepts(CORPUS, cuis=cuis, limit=VALID_LIMIT, verbose=True)
    concepts = concept_list.concepts
    for concept in concepts:
        assert concept.cui is not None
        assert concept.ontology is not None
...
def test_get_from_preferred_names():
    ...
    concept_list = IML_TEST.get_concepts(CORPUS, preferred_names=preferred_names, limit=VALID_LIMIT)
    assert concept_list is not None
    concepts = concept_list.concepts
    for concept in concepts:
        assert concept.cui is not None
...
def test_get_from_pnames_verbose():
    ...
    preferred_name = 'Heart'
    preferred_names.append(preferred_name)
    concept_list = IML_TEST.get_concepts(CORPUS, preferred_names=preferred_names, limit=VALID_LIMIT, verbose=True)
    assert concept_list is not None
    concepts = concept_list.concepts
    for concept in concepts:
        assert concept.cui is not None
...
def test_get_from_surface_forms():
    ...
    concept_list = IML_TEST.get_concepts(CORPUS, surface_forms=surface_forms, limit=VALID_LIMIT)
    assert concept_list is not None
    concepts = concept_list.concepts
...
def test_get_from_sforms_verbose():
    ...
    surface_form = 'cardiac'
    surface_forms.append(surface_form)
    concept_list = IML_TEST.get_concepts(CORPUS, surface_forms=surface_forms, limit=VALID_LIMIT, verbose=True)
    assert concept_list is not None
    concepts = concept_list.concepts
    assert concepts is not None
    for concept in concepts:
...
def test_get_from_sforms_sorted():
    ...
    surface_form = 'cardiac'
    surface_forms.append(surface_form)
    concept_list = IML_TEST.get_concepts(CORPUS, surface_forms=surface_forms,
...
def test_get_from_attributes():
    ...
    concept_list = IML_TEST.get_concepts(CORPUS, attributes=attributes, limit=VALID_LIMIT)
    assert concept_list is not None
    concepts = concept_list.concepts
    for concept in concepts:
        assert concept.cui is not None
...
def test_get_from_attrs_verbose():
    ...
    attribute = ATTRIBUTE
    attributes.append(attribute)
    concept_list = IML_TEST.get_concepts(CORPUS, attributes=attributes, limit=VALID_LIMIT, verbose=True)
    assert concept_list is not None
    concepts = concept_list.concepts
    for concept in concepts:
        assert concept.cui is not None
