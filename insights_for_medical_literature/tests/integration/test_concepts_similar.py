...
def test_get_similar_umls():
    concept_list = IML_TEST.get_similar_concepts(CORPUS, name_or_id=CUI, return_ontologies=ONTOLOGY)
...
def test_get_similar_umls_limit():
    concept_list = IML_TEST.get_similar_concepts(CORPUS, name_or_id=CUI, ontology=ONTOLOGY,
