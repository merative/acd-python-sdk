...
def test_categories_default():
    categories = IML_TEST.get_document_categories(corpus=CORPUS, document_id=DOC)
...
def test_categories_custom_tags():
    categories = IML_TEST.get_document_categories(corpus=CORPUS, document_id=DOC, highlight_tag_begin='<i>',
                                                highlight_tag_end='</i>')
    assert categories is not None
    assert categories.highlighted_title is not None
    assert categories.passages is not None
...
def test_categories_types_filter():
    ...
    categories = IML_TEST.get_document_categories(corpus=CORPUS, document_id=DOC, types=types)
    assert categories is not None
...
def test_categories_category_filter():
    categories = IML_TEST.get_document_categories(corpus=CORPUS, document_id=DOC, category='disorders')
    assert categories is not None
    assert categories.highlighted_title is not None
    assert categories.passages is not None
    assert categories.annotations is not None
...
def test_categories_negation_only():
    categories = IML_TEST.get_document_categories(corpus=CORPUS, document_id=DOC, only_negated_concepts=True)
    assert categories is not None
    assert categories.passages is not None
    assert categories.annotations is not None
...
def test_categories_fields_filter():
    ...
    categories = IML_TEST.get_document_categories(corpus=CORPUS, document_id=DOC, fields=fields)
    assert categories is not None
...
def test_categories_limit_filter():
    categories = IML_TEST.get_document_categories(corpus=CORPUS, document_id=DOC, limit=5)
    assert categories is not None
    assert categories.highlighted_title is not None
    assert categories.passages is not None
    assert categories.annotations is not None
