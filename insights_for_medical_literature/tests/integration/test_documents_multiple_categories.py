...
def test_multiple_categories():
    categories = IML_TEST.get_doc_multiple_categories(corpus=CORPUS, document_id=DOC, categories=INPUT_CATEGORIES)
...
def test_multiple_categories_fields():
    ...
    categories = IML_TEST.get_doc_multiple_categories(corpus=CORPUS, document_id=DOC,
