...
class InsightsForMedicalLiteratureServiceV1(BaseService):
    ...
    def get_documents(self, corpus):
        ...
        :return: Object representing document and provider counts in the corpus
        :rtype: CorpusInfoModel
        """
        ...
        return CorpusInfoModel._from_dict(response)
    ...
    def get_document_info(self, corpus, document_id, verbose=None):
        ...
        returned.
        :return: An object representing a corpus document
        :rtype: DocumentTextModel
        """
        ...
        request = self.prepare_request(method='GET', url=url, params=params)
        response = self.request_iml(request)
        return DocumentTextModel._from_dict(response)
    ...
    def get_document_categories(self, corpus, document_id, highlight_tag_begin=None,
        ...
        Default is 50.
        :param dict headers: A `dict` containing the request headers
        :return: An object categorizing document annotations.
        :rtype: CategoriesModel
        """
        ...
        request = self.prepare_request(method='GET', url=url, params=params)
        response = self.request_iml(request)
        return CategoriesModel._from_dict(response)
    ...
    def get_doc_multiple_categories(self, corpus, document_id, categories=None, highlight_tag_begin=None,
        ...
        :param int limit: Limit the number of passages per search concept (1 to 250).
        Default is 50.
        :return: An object with the specified annotation categories
        :rtype: CategoriesModel
        """
    ...
    def get_search_matches(self, corpus, document_id, min_score, cuis=None, text=None,
        ...
        annotations, highlightedTitle, highlightedAbstract, highlightedBody,
        highlightedSections.
        :return: An object representing search matches found with in a document.
        :rtype: SearchMatchesModel
        """
        ...
        request = self.prepare_request(method='GET', url=url, params=params)
        response = self.request_iml(request)
        return SearchMatchesModel._from_dict(response)
    ...
    def search(self, corpus, query=None, returns=None, verbose=None):
        ...
        :param dict headers: A `dict` containing the request headers
        :return: An object containing the `SearchModel` response.
        :rtype: SearchModel
        """
        if corpus is None:
            raise ValueError('corpus must be provided')
        ...
        return SearchModel._from_dict(response)
    ...
    def get_fields(self, corpus):
        ...
        :param str corpus: Corpus name.
        :param dict headers: A `dict` containing the request headers
        :return: An object listing content fields in the corpus.
        :rtype: MetadataModel
        """
        ...
        return MetadataModel._from_dict(response)
    ...
    def typeahead(self, corpus, query, ontologies=None, types=None, category=None, verbose=None,
        ...
        :return: A list of corpus ontology items matching the query input.
        :rtype: ConceptListModel
        """
        ...
        request = self.prepare_request(method='GET', url=url, params=params)
        response = self.request_iml(request)
        return ConceptListModel._from_dict(response)
    ...
    def get_corpora_config(self, verbose=None):
        ...
        :return: A list of corpora for the service instance.
        :rtype: CorporaConfigModel
        """
        ...
        return CorporaConfigModel._from_dict(response)
    ...
    def get_corpus_config(self, corpus, verbose=None):
        ...
        :param str corpus: Corpus name.
        :param bool verbose: Verbose output.  Default verbose = false.
        :return: An objec representing a configured corpus.
        :rtype: CorporaConfigModel
        """
    ...
    def get_semantic_types(self, corpus):
        ...
        :param str corpus: Corpus name.
        :return: An object listing semantic types found in the corpus.
        :rtype: TypesModel
        """
        ...
        request = self.prepare_request(method='GET', url=url, params=params)
        response = self.request_iml(request)
        return TypesModel._from_dict(response)
    ...
    def get_concepts(self, corpus, cuis=None, preferred_names=None, surface_forms=None,
        ...
        :return: A list of concepts matching the input criteria.
        :rtype: ConceptListModel
        """
    ...
    def get_cui_info(self, corpus, name_or_id, ontology=None, fields=None, tree_layout=None):
        ...
        :return: An object representing an ontology artifact.
        :rtype: ConceptInfoModel
        """
        ...
        request = self.prepare_request(method='GET', url=url, params=params)
        response = self.request_iml(request)
        return ConceptInfoModel._from_dict(response)
    ...
    def get_related_concepts(self, corpus, name_or_id, relationship, ontology=None,
        ...
        :return: A list of concepts related to the specified concept.
        :rtype: RelatedConceptsModel
        """
        ...
        request = self.prepare_request(method='GET', url=url, params=params)
        response = self.request_iml(request)
        return RelatedConceptsModel._from_dict(response)
    ...
    def get_similar_concepts(self, corpus, name_or_id, ontology=None, return_ontologies=None,
        ...
        ontologies.
        :param int limit: Number of possible concepts to return. Default is 250.
        :return: A list of concepts similar to the specified concept.
        :rtype: ConceptListModel
        """
