...
class AnnotatorForClinicalDataV1(BaseService):
    ...
    def analyze(self, text, flow):
        ...
        if isinstance(text, list):
            ...
            result = (ContainerGroup._from_dict(self.analyze_org(list_unstructure_container,
                                                                 list_annotator_flow)).unstructured[0].data)
    ...
    def analyze_with_flow(self, flow_id, text):
        ...
        if isinstance(text, list):
            ...
            result = ContainerGroup._from_dict(result)
            ...
            result = self.analyze_with_flow_org(flow_id, request_container._to_dict(), 'application/json')
            result = ContainerGroup._from_dict(result).unstructured[0].data
        else:
    ...
    def get_annotator(self, id):
        ...
        :rtype: watson_health_cognitive_services.annotator_for_clinical_data_v1.Annotator
        """
        params = {
            'version': self.version
        }
        ...
        return Annotator._from_dict(response)
    ...
    def get_flow(self, id):
        ...
        :param str id: Flow ID.
        :return: A `AcdFlow` object
        :rtype: watson_health_cognitive_services.annotator_for_clinical_data_v1.AcdFlow
        """
        ...
        return AcdFlow._from_dict(response)
    ...
    def update_persisted_flow(self, flow_id=None, new_name=None, new_description=None, new_annotator_flows=None):
        ...
        response = self.request_acd(request)
 #       response = self.request_acd(method='PUT',
 #           url=self.url + 'v1/flows/{0}'.format(id),
 #           params=params,
 #           data=data,
 #           headers=headers,
 #           verify=False)
    ...
    def get_profile(self, id):
        ...
        :param str id: Profile ID.
        :return: A `AcdProfile` object
        :rtype: watson_health_cognitive_services.annotator_for_clinical_data_v1.AcdProfile
        """
        ...
        return AcdProfile._from_dict(response)
