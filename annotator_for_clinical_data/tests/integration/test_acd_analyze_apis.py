...
import watson_health_cognitive_services.annotator_for_clinical_data.tests.common.test_unstructured_container as tuc
...
def test_analyze_flow_org():
    ...
    container_group = wh.ContainerGroup._from_dict(response)
