...
def test_set_corpus_schema():
    targets = []
    target1 = {}
    target1['contendField'] = 'test'
    target1['enrichmentField'] = 'test'
    fields = []
    field1 = {}
    field1['fieldName'] = 'test'
    field1['usageType'] = 'test'
    refs = {}
    refs['dictionaryIndex'] = 'test'
    refs['attributeIndex'] = 'test'
    refs['meshIndex'] = 'test'

    try:
        IML_TEST.set_corpus_schema(user_name='test', password='test', corpus_uri='test', enrichment_targets=targets,
                                   metadata_fields=fields, corpus_name='test', references=refs)
